// AI Service for OpenRouter API integration with Supabase real-time data
...
class AIService {
  ...
  private async fetchLiveWebsiteData(): Promise<LiveWebsiteData> {
    try {
      ...
      const projects: SupabaseProject[] = projectsData || [];
      ...
      const socialPosts: SupabaseSocialPost[] = socialData || [];
