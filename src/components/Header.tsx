      ...
      <div className="container mx-auto px-4 py-4">
        <div className="flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            ...
            <Link to="/projects" className="text-foreground/90 hover:text-primary transition-colors duration-300 relative font-mono text-sm font-medium drop-shadow-sm">
              Projects
            ...
            <Link to="/social-media" className="text-foreground/90 hover:text-primary transition-colors duration-300 relative font-mono text-sm font-medium drop-shadow-sm">
              Social Media
              <span className="absolute -bottom-1 left-0 block w-0 h-0.5 bg-gradient-primary transition-all duration-300 hover:w-full" />
            </Link>
            <Link to="/achievements" className="text-foreground/90 hover:text-primary transition-colors duration-300 relative font-mono text-sm font-medium drop-shadow-sm">
              Achievements
              <span className="absolute -bottom-1 left-0 block w-0 h-0.5 bg-gradient-primary transition-all duration-300 hover:w-full" />
            </Link>
          </nav>
